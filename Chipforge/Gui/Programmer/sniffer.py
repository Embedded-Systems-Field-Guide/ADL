...
def create_sniffer_interface(parent, colors):
    """
    Create the Sniffer interface.
    """
    # Main frame
    ...
    info_label = tk.Label(
        main_frame,
        text="⚠ Sniffer can only read data between EEPROM and the ECF8F24 MCU",
    ...
    set_button = tk.Button(
        button_frame,
        text="Set to Sniffer",
        command=lambda: set_mode("SNF", response_label),
        bg=colors['bg'],
        fg=colors['fg'],
        font=('Arial', 12, 'bold'),
        padx=30,
